...
def train_model(epoch, model, optimizer,
    ...
    sys.stdout.write("Epoch={} iter={} lr={:.6f} train_loss={:.6f} test_acc={:.6f}\n".format(
        epoch, niter,
...
def main(args):
    ...
    #         save_data(test_x, test_y, args.path, 'test')
        train_x, train_y = dataloader.read_corpus('/train.txt')
        test_x, test_y = dataloader.read_corpus('/test.txt')
        ...
        train_x, train_y = dataloader.read_corpus('/home/ubuntu/workplace/PTH/TextFooler-master/data/train/MNLI/mnli_train')
        test_x, test_y = dataloader.read_corpus('/home/ubuntu/workplace/PTH/TextFooler-master/data/mnli_mis')
...
if __name__ == "__main__":
    ...
    argparser.add_argument("--dataset", type=str, default="mnli", help="which dataset")
    ...
    argparser.add_argument("--max_epoch", type=int, default=150)
    argparser.add_argument("--d", type=int, default=700)
    ...
    argparser.add_argument("--save_path", type=str, default='/home/ubuntu/workplace/PTH/TextFooler-master/target_models/LSTM/mnli')
